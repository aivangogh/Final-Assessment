        ...
        <div class="right-column">
            ...
            <form id="registration-form" method="POST" action="includes/signup.php" novalidate>
                <div class="form">
                    <div class="form-left-column">
                        ...
                        <div class="input-container">
                            ...
                            <input class="input" id="first-name" type="text" name="first-name" value="<?php echo ((isset($_POST["edit-btn"])) ? $user["first_name"] : ''); ?>" placeholder="FIRST NAME *" pattern="[A-Za-z]{1,15}" title="Name should only contain letters. e.g John" required>
                        </div>

                        <div class="input-container">
                            <label class="input-header" for="middle-name">Middle Name</label>
                            <input class="input" id="middle-name" type="text" name="middle-name" value="<?php echo ((isset($_POST["edit-btn"])) ? $user["middle_name"] : ''); ?>" placeholder="MIDDLE NAME *" pattern="[A-Za-z]{1,15}" title="Name should only contain letters. e.g Forest" required>
                        </div>
                ...
                <div class="actions">
                    ...
                    <button type="submit" name="cancel-btn">Cancel</button>
                </div>
            </form>
