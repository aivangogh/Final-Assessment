...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2021 at 10:16 AM
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `middle_name`, `last_name`, `phone`, `gender`, `course_id`, `year_level`, `role`) VALUES
(1234567890, '1234567890@admin.buksu.edu.ph', 'qwerty123', 'Haytham', 'Edward', 'Kenway', '', 'male', 'BSN', 5, 'admin'),
(1901101401, '1901101401@student.buksu.edu.ph', 'qwerty123', 'Ivan', 'Pasulohan', 'Gemota', '0987654321', 'male', 'BSN', 2, 'student'),
(1901101402, '1901101402@student.buksu.edu.ph', 'qwerty123', 'Ivana', 'Smith', 'Alawi', '', 'female', 'BSN', 5, 'student'),
(1901101403, '1901101403@student.buksu.edu.ph', 'qwerty123', 'Ivan', 'Pasulohan', 'Gemota', '0987654321', 'male', 'BSEMC', 2, 'student');
